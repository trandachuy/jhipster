...
@WithMockUser
@EmbeddedKafka
class JhipsterExampleKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/jhipster-example-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/jhipster-example-kafka/consume")
